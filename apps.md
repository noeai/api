...
Pole `show_in_module` pozwala osadzić aplikację Noe wewnątrz wybranego modułu systemu [Intum](https://github.com/intum/api) więcej informacji [https://github.com/intum/api/blob/master/noe-intum.md](https://github.com/intum/api/blob/master/noe-intum.md)
